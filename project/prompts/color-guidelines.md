# Colors
- Use the semantic color variables defined in `app/styles/theme.css` as the default vocabulary.
- Keep the palette grounded in the project's brand mood: plant life, clarity, calm, and trust.
- Use accent colors for actions and highlights, neutral colors for layout and typography, success for confirmations, and error for failures.
- Preserve contrast and accessibility before decorative nuance.
- Prefer tokens over hard-coded values unless a component needs a narrowly scoped exception.
# Colors
