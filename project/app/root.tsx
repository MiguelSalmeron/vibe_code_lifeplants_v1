...
export const links: Route.LinksFunction = () => [
  ...
  {
    rel: "stylesheet",
    href: "https://fonts.googleapis.com/css2?family=Tenor+Sans&family=Lexend:wght@300;400;500;600;700&family=Montserrat:wght@700&display=swap",
  },
];
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="es" suppressHydrationWarning className={rootCssClass} style={{ colorScheme: resolvedScheme }}>
      <head>
        <meta charSet="utf-8" />
